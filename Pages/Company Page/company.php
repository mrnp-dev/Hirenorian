    ...
    <div class="right-panel">
        ...
        <div class="steps">
            <div class="step active-step">
                <div class="step-icon"><img src="../images/1User_Dark.png" alt="User Icon"></div>
                <span class="step-text">Company Profile</span>
            </div>
            <div class="step">
                <div class="step-icon"><img src="../images/1Book_Dark.png" alt="Book Icon"></div>
                <span class="step-text">Brief Background</span>
            </div>
            <div class="step">
                <div class="step-icon"><img src="../images/1Briefcase_Dark.png" alt="Briefcase Icon"></div>
