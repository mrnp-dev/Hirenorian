<?php
session_start();
$company_id = isset($_GET['id']) ? htmlspecialchars($_GET['id']) : '';
?>
...
<body>
        ...
        <div class="main-content">
            ...
            <main class="dashboard-body">
                <div class="d-flex align-items-center gap-3 mb-4">
                    <a href="company_management.php" class="btn btn-outline-secondary btn-sm">
                        <i class="fa-solid fa-arrow-left"></i> Back
                    </a>
                    <h2 class="page-title m-0">Company Documents</h2>
                </div>

                <div class="card p-4 border-0 shadow-sm">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="m-0">Documents for: <span class="text-primary" id="companyNameDisplay">Loading...</span></h4>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!companyId) {
                showError('No Company ID provided. Please go back and select a company.');
                return;
            }
                    ...
                    swal({
                        ...
                        .then((value) => {
                            if (value === "Approved" || value === "Rejected" || value === "Pending") {
                                updateVerificationStatus(companyId, value);
                            }
                        });
                });
            }
            ...
            fetch(apiUrl)
                ...
                .then(data => {
                    ...
                    if (data.status === 'success') {
                        ...
                        updateDocumentCard('dole', data.data.dole_path);
                        updateDocumentCard('bir', data.data.bir_path);
                        updateDocumentCard('mayor', data.data.mayor_permit_path);
                        updateDocumentCard('businesstype', data.data.business_type_doc_path);
